...
import com.example.baatcheet.databinding.ActivitySettingsBinding;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.textView6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(SettingsActivity.this, "For any help, please contact me on 8003070496", Toast.LENGTH_SHORT).show();
            }
        });
        binding.textView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(SettingsActivity.this, "This is Ashutosh Singh, currently pursuing my bachelor from MNNIT Allahabad in CSE ", Toast.LENGTH_SHORT).show();
            }
        });
